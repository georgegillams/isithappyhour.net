...
const projectName = 'ISITHAPPYHOUR';
const projectTitle = 'Is It Happy Hour?';
const projectDescription = "Find out if it's happy hour yet.";
const githubRepo = 'georgegillams/isithappyhour.net';
...
const domain = useLocalhost ? `localhost:${port}` : 'www.isithappyhour.net';
